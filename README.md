...
![](/images/StartFrame.png)


1. Uploading image files:
![](/images/FileOpenerDialog.png)

2. Misuse handleing: if a file which is not an image is uploaded the GUI will open a warning window.
